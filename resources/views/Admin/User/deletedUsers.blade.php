...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <x-admin.menuBar>
                <a href="{{route('admin.users.index')}}" class="mb-0 text-decoration-none text-black-50">
                    <span class="">
                ...
                <a href="{{route('admin.users.deletedUsers')}}" class="mb-0 text-decoration-none text-primary">
                    <span class="">
                        Deleted Users
                ...
                <table class="table text-start text-black-50 table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="">
                                <form action="{{route('admin.users.restore',$user->id)}}" class="d-none" method="POST"
                                    id="restoreUser{{$user->id}}">
                                    @csrf
                                    @method('PATCH')
                                </form>
                                <button form="restoreUser{{$user->id}}" type="submit"
